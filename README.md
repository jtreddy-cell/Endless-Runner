...
Audio:
Integrate sound effects DONE
Include background music DONE
...
Background music from https://pixabay.com/music/search/gaming/. 
...
DONE Include one or more animated characters that use a texture atlas/sprite sheet* (1) 
...
DONE Use a minimum of four sound effects for key mechanics, UI, and/or significant events appropriate to your game design (1)
